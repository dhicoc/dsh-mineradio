...
const MINERADIO_PLACEHOLDER = {
  zh: '说点什么，给今天定个调…',
  en: 'Say something to set today\'s tone…',
}
 ...
 */
export function mineradioPlaceholder(locale: string): string {
  return MINERADIO_PLACEHOLDER[locale === 'zh' ? 'zh' : 'en']
}
