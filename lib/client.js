window.__ModuleLoader__.load({
  id: "@deepseek-ai/dsh-client-ui-mineradio",
  factory: (require) => {
    var module = { exports: {} };
...
if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("@deepseek-ai/dsh-client-ui-mineradio/src/client/MineradioPluginCard.module.css?v=cc6e6e9b") + "]") === null) {
  const tag = document.createElement("style");
  tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-mineradio";
  tag.dataset.pluginCss = "@deepseek-ai/dsh-client-ui-mineradio/src/client/MineradioPluginCard.module.css?v=cc6e6e9b";
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: MineradioAppearanceRow_default.subGroup, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: MineradioAppearanceRow_default.controls, children: [
        ...
        background === "fluid" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Knob, { label: t("mineradio.fluidHue"), value: fluidHue, min: 0, max: 360, step: 1, unit: "\xB0", onChange: setFluidHue }),
...
var OVERRIDE_SOURCE = "@deepseek-ai/dsh-client-ui-mineradio";
...
if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("@deepseek-ai/dsh-client-ui-mineradio/src/client/mineradio.module.css?v=135b729b") + "]") === null) {
  const tag = document.createElement("style");
  tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-mineradio";
  tag.dataset.pluginCss = "@deepseek-ai/dsh-client-ui-mineradio/src/client/mineradio.module.css?v=135b729b";
  tag.textContent = `[data-dsh-aqua] body{background:var(--dsw-alias-bg-base);}[data-dsh-aqua]{--dsh-aqua-glass-card-light:color-mix(in srgb,rgb(249 244 233) calc(46% * var(--dsh-aqua-frost,1)),transparent);--dsh-aqua-glass-card-dark:color-mix(in srgb,rgb(38 36 32) calc(52% * var(--dsh-aqua-frost,1)),transparent);--dsh-aqua-bloom:hsla(var(--dsh-aqua-bloom-h,44),82%,66%,0.10);}[data-dsh-aqua] [data-dsh-frame]{background:transparent;}[data-dsh-aqua] [data-phase],[data-dsh-aqua] [data-dsh-details]{background:transparent;}[data-dsh-float] [data-phase='active'] header{position:relative;z-index:8;}[data-dsh-float] [class*='banner']{position:static;}[data-dsh-float] [data-phase='active'] [data-conversation-scroll]{margin-top:-95px;padding-top:107px;}[data-dsh-aqua] [data-phase] [class*='composerSeat'][class*='composerSeat']{background:none;}[data-dsh-aqua] [data-dsh-aqua-ambient]{position:fixed;inset:0;z-index:-1;pointer-events:none;overflow:hidden;background:radial-gradient(760px 420px at 50% -8%,rgba(160,200,255,0.26),transparent 70%),linear-gradient(180deg,rgba(156,193,231,0.22) 0%,rgba(156,193,231,0) 38%),radial-gradient(900px 420px at 50% 108%,rgba(156,193,231,0.14),transparent 70%);}[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-aqua-ambient]{background:radial-gradient(760px 420px at 50% -8%,rgba(110,165,255,0.13),transparent 70%),linear-gradient(180deg,rgba(94,143,224,0.13) 0%,rgba(94,143,224,0) 46%),radial-gradient(900px 420px at 50% 108%,rgba(94,143,224,0.09),transparent 70%);}[data-dsh-aqua] [data-dsh-aqua-ambient]::after{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,var(--dsh-aqua-brightness-white,0)),rgba(255,255,255,var(--dsh-aqua-brightness-white,0))),linear-gradient(rgba(0,0,0,var(--dsh-aqua-brightness-black,0)),rgba(0,0,0,var(--dsh-aqua-brightness-black,0)));}@media (prefers-reduced-motion:no-preference){[data-dsh-aqua] [data-dsh-aqua-ambient]{animation:dsh-aqua-breathe 9s var(--ds-ease-in-out) infinite alternate;}}@keyframes dsh-aqua-breathe{from{opacity:0.86;}to{opacity:1;}}[data-dsh-aqua] [data-dsh-aqua-fluid-canvas]{position:absolute;inset:0;width:100%;height:100%;}[data-dsh-aqua] [data-dsh-aqua-wallpaper]{position:fixed;inset:0;z-index:-1;overflow:hidden;}[data-dsh-aqua] [data-dsh-aqua-wallpaper-img]{width:100%;height:100%;object-fit:cover;}[data-dsh-aqua] [data-dsh-aqua-wallpaper-video]{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;border:0;pointer-events:none;filter:blur(var(--dsh-aqua-video-blur,0px));}[data-dsh-aqua] [data-dsh-aqua-wallpaper-img]{filter:blur(var(--dsh-aqua-wallpaper-blur,0px));}[data-dsh-aqua] [data-dsh-aqua-wallpaper]::after{content:'';position:absolute;inset:0;background:rgb(255 255 255 / var(--dsh-aqua-wallpaper-frost,0));pointer-events:none;}[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-aqua-wallpaper]::after{background:rgb(12 18 27 / var(--dsh-aqua-wallpaper-frost,0));}[data-dsh-aqua] [data-dsh-aqua-wallpaper][data-media='video']::after{display:block;background:rgb(255 255 255 / calc(var(--dsh-aqua-video-dim,0.36) * 1.3));}[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-aqua-wallpaper][data-media='video']::after{background:rgb(8 12 20 / var(--dsh-aqua-video-dim,0.36));}[data-dsh-aqua] [data-dsh-aqua-whale]{position:absolute;transform:translate(-50%,-50%);pointer-events:none;mix-blend-mode:screen;opacity:0.92;}[data-dsh-aqua] [data-dsh-aqua-whale][data-scheme='light']{mix-blend-mode:multiply;}[data-dsh-aqua] [data-dsh-aqua-whale] canvas{display:block;width:100%;height:100%;}[data-dsh-aqua] [data-dsh-aqua-ambient][data-background='wallpaper'] [data-dsh-aqua-fluid-canvas]{display:none;}[data-dsh-aqua] [data-dsh-aqua-wallpaper][data-background='fluid']{display:none;}[data-dsh-aqua] [data-dsh-aqua-mesh]{position:absolute;inset:0;width:100%;height:100%;pointer-events:none;}[data-dsh-aqua] [data-dsh-aqua-ambient][data-critters='off'] [data-aqua-critter]{display:none;}[data-dsh-aqua] [data-aqua-critter]{position:absolute;color:#7ea4df;opacity:0.22;}[data-dsh-aqua] [data-aqua-critter='fish']{animation:dsh-aqua-fish-swim 12s var(--ds-ease-in-out) infinite;}[data-dsh-aqua] [data-aqua-critter='fish-left']{animation:dsh-aqua-fish-swim-left 16s var(--ds-ease-in-out) infinite;}[data-dsh-aqua] [data-aqua-critter='bubble']{color:#a9c6ef;opacity:0;animation:dsh-aqua-bubble-rise 9s ease-in infinite;}[data-dsh-aqua] [data-aqua-critter='plankton']{color:#7ea4df;animation:dsh-aqua-plankton 5s ease-in-out infinite;}@keyframes dsh-aqua-fish-swim{0%{transform:translate3d(0,0,0) rotate(-5deg);}30%{transform:translate3d(40px,-15px,0) rotate(4deg);}70%{transform:translate3d(52px,-18px,0) rotate(3deg);}100%{transform:translate3d(0,0,0) rotate(-5deg);}}@keyframes dsh-aqua-fish-swim-left{0%{transform:translate3d(0,0,0) scaleX(-1) rotate(-5deg);}30%{transform:translate3d(-34px,-12px,0) scaleX(-1) rotate(4deg);}70%{transform:translate3d(-44px,-15px,0) scaleX(-1) rotate(3deg);}100%{transform:translate3d(0,0,0) scaleX(-1) rotate(-5deg);}}@keyframes dsh-aqua-bubble-rise{0%{transform:translate3d(0,0,0);opacity:0;}10%{opacity:0.5;}100%{transform:translate3d(8px,-150px,0);opacity:0;}}@keyframes dsh-aqua-plankton{0%,100%{opacity:0.1;}50%{opacity:0.38;}}[data-dsh-float] [role='menu'],[data-dsh-float] [role='dialog'],[data-dsh-float] [role='alert'],[data-dsh-float] [data-dsh-surface]{border-radius:14px;}[data-dsh-float] [data-dsh-surface]{background:color-mix(in srgb,rgb(255 255 255) calc(62% * var(--dsh-aqua-surface-frost,1)),transparent);border:1px solid rgba(19,45,83,0.16);box-shadow:inset 0 1px 0 rgba(255,255,255,0.45);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] [data-dsh-surface]:hover:not(:disabled){background:color-mix(in srgb,rgb(255 255 255) calc(74% * var(--dsh-aqua-surface-frost,1)),transparent);}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-surface]{background:color-mix(in srgb,rgb(42 46 56) calc(62% * var(--dsh-aqua-surface-frost,1)),transparent);border-color:rgba(148,180,220,0.2);box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-surface]:hover:not(:disabled){background:color-mix(in srgb,rgb(54 58 70) calc(70% * var(--dsh-aqua-surface-frost,1)),transparent);}[data-dsh-float] [role='menuitem'],[data-dsh-float] [role='tooltip'],[data-dsh-float] [class*='pill']{border-radius:8px;}[data-dsh-float] button[class*='button']{border-radius:10px;}[data-dsh-float] [class*='iconButton'],[data-dsh-float] [class*='searchButton']{border-radius:8px;}[data-dsh-float] [data-dsh-add]{background:color-mix(in srgb,rgb(255 255 255) calc(40% * var(--dsh-aqua-frost,1)),transparent);border:1px solid rgba(19,45,83,0.18);box-shadow:inset 0 1px 0 rgba(255,255,255,0.5);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] [data-dsh-add]:hover:not(:disabled){background:color-mix(in srgb,rgb(255 255 255) calc(58% * var(--dsh-aqua-frost,1)),transparent);}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-add]{background:color-mix(in srgb,rgb(42 46 56) calc(40% * var(--dsh-aqua-frost,1)),transparent);border-color:rgba(148,180,220,0.25);box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-add]:hover:not(:disabled){background:color-mix(in srgb,rgb(54 58 70) calc(52% * var(--dsh-aqua-frost,1)),transparent);}[data-dsh-float] [class*='bubble']{border-radius:14px;border:1px solid rgba(19,45,83,0.14);background:color-mix(in srgb,rgb(255 255 255) calc(42% * var(--dsh-aqua-frost,1)),transparent);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] body[data-ds-dark-theme] [class*='bubble']{border-color:rgba(148,180,220,0.14);background:color-mix(in srgb,rgb(0 0 0) calc(40% * var(--dsh-aqua-frost,1)),transparent);}html[data-dsh-float][data-dsh-aqua-wallpaper][data-dsh-aqua-media='video'] [class*='bubble']{background:color-mix(in srgb,rgb(255 255 255) 70%,transparent);border-color:rgba(19,45,83,0.2);}html[data-dsh-float][data-dsh-aqua-wallpaper][data-dsh-aqua-media='video'] body[data-ds-dark-theme] [class*='bubble']{background:color-mix(in srgb,rgb(0 0 0) 50%,transparent);border-color:rgba(148,180,220,0.22);}[data-dsh-float] [class*='card']{border-radius:14px;}[data-dsh-float] [data-composer-card],[data-dsh-float] [data-composer-card]::after{border-radius:24px;}[data-dsh-float] [data-composer-card]{position:relative;z-index:8;background:var(--dsh-aqua-glass-card-light);border:1px solid rgba(19,45,83,0.26);box-shadow:inset 0 1px 0 rgba(255,255,255,0.5),0 10px 36px rgba(19,45,83,0.16);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] body[data-ds-dark-theme] [data-composer-card]{background:var(--dsh-aqua-glass-card-dark);border:1px solid rgba(148,180,220,0.32);box-shadow:inset 0 1px 0 rgba(255,255,255,0.07),0 10px 36px rgba(2,6,14,0.5);}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]){width:calc(var(--dsh-chat-content-width) + 32px);max-width:none;margin:0 auto 12px;padding:0;border:1px solid rgba(19,45,83,0.26);border-radius:24px;background:var(--dsh-aqua-glass-card-light);box-shadow:inset 0 1px 0 rgba(255,255,255,0.5),0 10px 36px rgba(19,45,83,0.16);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-inputbar]:has([data-dsh-stats]){border-color:rgba(148,180,220,0.32);background:var(--dsh-aqua-glass-card-dark);box-shadow:inset 0 1px 0 rgba(255,255,255,0.07),0 10px 36px rgba(2,6,14,0.5);}[data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-composer-card]{border:none;border-radius:0;background:transparent;box-shadow:none;backdrop-filter:none;}[data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-composer-card]::after{display:none;}[data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats]{width:100%;max-width:none;margin:auto 0 0;min-height:24px;box-sizing:border-box;display:block;padding:2px 16px;border:none;border-top:1px solid rgba(19,45,83,0.18);border-radius:0;background:transparent;box-shadow:none;backdrop-filter:none;}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats]{border-top-color:rgba(148,180,220,0.24);}[data-dsh-float] [data-composer-card]::after{-webkit-mask:url("data:image/svg+xml,%3Csvg xmlns='http://www.mineradio_w3.mineradio_org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='none' rx='24' ry='24' stroke='black' stroke-width='2' stroke-dasharray='4 4'/%3E%3C/svg%3E");mask:url("data:image/svg+xml,%3Csvg xmlns='http://www.mineradio_w3.mineradio_org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='none' rx='24' ry='24' stroke='black' stroke-width='2' stroke-dasharray='4 4'/%3E%3C/svg%3E");}[data-dsh-float] [class*='block']{border-radius:14px;--dsl-code-block-border-radius:14px;--dsl-diff-radius:14px;--dsl-read-radius:14px;--dsl-terminal-radius:14px;--dsl-web-radius:14px;--dsl-search-radius:14px;}[data-dsh-float] header{margin:12px 16px 0;padding:10px 16px 8px;border:1px solid rgba(19,45,83,0.26);border-bottom-color:transparent;border-radius:20px;background:var(--dsh-aqua-glass-card-light);box-shadow:inset 0 1px 0 rgba(255,255,255,0.5),0 10px 34px rgba(19,45,83,0.16);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] header::after{display:none;}[data-dsh-float] body[data-ds-dark-theme] header{border-color:rgba(148,180,220,0.32);border-bottom-color:transparent;background:var(--dsh-aqua-glass-card-dark);box-shadow:inset 0 1px 0 rgba(255,255,255,0.07),0 8px 30px rgba(2,6,14,0.32);}[data-dsh-float] [data-dsh-frame][data-sidebar-collapsed] header{margin-left:28px;}[data-dsh-float] [class*='sidebarCol']{position:relative;z-index:9;margin:12px;padding:10px 12px 14px;border:1px solid rgba(19,45,83,0.26);border-right:1px solid rgba(150,190,245,0.65);border-radius:20px;background:var(--dsh-aqua-glass-card-light);backdrop-filter:blur(var(--dsh-aqua-blur,14px));box-shadow:inset 0 1px 0 rgba(255,255,255,0.5),0 10px 34px rgba(19,45,83,0.16);overflow:hidden;}[data-dsh-float] body[data-ds-dark-theme] [class*='sidebarCol']{border-color:rgba(148,180,220,0.32);border-right:1px solid rgba(148,180,220,0.2);background:var(--dsh-aqua-glass-card-dark);box-shadow:inset 0 1px 0 rgba(255,255,255,0.07),0 8px 30px rgba(2,6,14,0.32);}[data-dsh-float] [data-dsh-frame][data-sidebar-collapsed] [class*='sidebarCol']{margin:12px -12px 12px 12px;padding:0;border-radius:16px;transition:margin 150ms var(--ds-ease-in-out),border-radius 150ms var(--ds-ease-in-out),transform 0.1s ease-out;}[data-dsh-float] [data-dsh-frame]:not([data-sidebar-collapsed]) [data-dsh-sidebar-root]{width:100% !important;}[data-dsh-float] [data-dsh-trajectory]{margin:8px 16px 12px;width:calc(100% - 32px);height:calc(100% - 20px);border:1px solid rgba(19,45,83,0.26);border-radius:20px;background:var(--dsh-aqua-glass-card-light);box-shadow:inset 0 1px 0 rgba(255,255,255,0.5),0 10px 34px rgba(19,45,83,0.16);backdrop-filter:blur(var(--dsh-aqua-blur,14px));overflow:hidden;}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-trajectory]{border-color:rgba(148,180,220,0.32);background:var(--dsh-aqua-glass-card-dark);box-shadow:inset 0 1px 0 rgba(255,255,255,0.07),0 8px 30px rgba(2,6,14,0.32);}[data-dsh-float] [data-dsh-trajectory] [role='toolbar'],[data-dsh-float] [data-dsh-trajectory] section[aria-label='Trajectory timeline']{background:transparent;}[data-dsh-float] [data-dsh-inputbar]:not([class*='hero']){padding-bottom:12px;}[data-dsh-float] [data-dsh-stats]{position:relative;z-index:8;width:calc(var(--dsh-chat-content-width) + 32px);max-width:none;margin:0 auto;padding:2px 16px;border:1px solid rgba(19,45,83,0.26);border-top:1px solid rgba(19,45,83,0.18);border-radius:0 0 24px 24px;background:var(--dsh-aqua-glass-card-light);box-shadow:0 10px 36px rgba(19,45,83,0.16);backdrop-filter:blur(var(--dsh-aqua-blur,14px));color:rgb(38 46 62 / 0.9);}[data-dsh-float] body[data-ds-dark-theme] [data-dsh-stats]{border-color:rgba(148,180,220,0.32);border-top-color:rgba(148,180,220,0.24);background:var(--dsh-aqua-glass-card-dark);box-shadow:0 10px 36px rgba(2,6,14,0.5);color:rgb(228 236 248 / 0.92);}[data-dsh-float] [data-composer-card] textarea::placeholder{color:rgb(55 64 84 / 0.5);}[data-dsh-float] body[data-ds-dark-theme] [data-composer-card] textarea::placeholder{color:rgb(205 216 234 / 0.52);}[data-dsh-aqua][data-dsh-aqua-spotlight] [data-dsh-aqua-spot]{position:relative;isolation:isolate;}[data-dsh-aqua] [data-dsh-aqua-glow]{display:none;}[data-dsh-aqua][data-dsh-aqua-spotlight] [data-dsh-aqua-glow]{display:block;position:absolute;inset:0;border-radius:inherit;pointer-events:none;opacity:0;transition:opacity 0.3s ease;z-index:-1;}[data-dsh-aqua][data-dsh-aqua-spotlight] [data-dsh-aqua-spot][data-spot-on] [data-dsh-aqua-glow]{opacity:1;}[data-dsh-aqua][data-dsh-aqua-spotlight] [data-dsh-inputbar][data-dsh-aqua-spot] [data-dsh-aqua-glow]{border-radius:24px;}[data-dsh-aqua][data-dsh-float] [class*='sidebarCol']:has([role='dialog']){backdrop-filter:none;}[data-dsh-float][data-dsh-aqua-press] [data-dsh-aqua-spot]{transition:transform 0.1s ease-out;}[data-dsh-aqua] body [role='dialog']{background:rgba(255,255,255,0.45);backdrop-filter:blur(50px);}[data-dsh-aqua] body[data-ds-dark-theme] [role='dialog']{background:rgba(17,26,39,0.55);}[data-dsh-float] [role='treeitem'][aria-selected='true']{box-shadow:inset 2px 0 0 var(--dsw-specific-sidebar-nav-item-active-accent),0 0 16px rgba(110,155,232,0.14);}[data-dsh-float] button[class*='button']:hover:not(:disabled),[data-dsh-float] [role='menuitem']:hover:not(:disabled){box-shadow:0 0 12px rgba(110,155,232,0.16),inset 0 0 0 1px rgba(148,180,220,0.22);}[data-dsh-float] [role='menu']{background:color-mix(in srgb,rgb(255 255 255) calc(62% * var(--dsh-aqua-frost,1)),transparent);backdrop-filter:blur(var(--dsh-aqua-blur,14px));}[data-dsh-float] body[data-ds-dark-theme] [role='menu']{background:color-mix(in srgb,rgb(28 32 42) calc(68% * var(--dsh-aqua-frost,1)),transparent);}[data-dsh-aqua] [data-dsh-aqua-fade]{position:fixed;left:0;right:0;height:13px;z-index:7;pointer-events:none;backdrop-filter:blur(5px);background:rgba(255,255,255,0.2);}[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-aqua-fade]{background:rgba(0,0,0,0.15);}[data-dsh-aqua] [data-dsh-aqua-fade='top']{top:0;-webkit-mask-image:linear-gradient(180deg,black 0%,transparent 100%);mask-image:linear-gradient(180deg,black 0%,transparent 100%);}[data-dsh-aqua] [data-dsh-aqua-fade='bottom']{bottom:0;-webkit-mask-image:linear-gradient(0deg,black 0%,transparent 100%);mask-image:linear-gradient(0deg,black 0%,transparent 100%);}[data-dsh-aqua]:focus-visible{outline:2px solid rgba(110,155,232,0.85);outline-offset:1px;}[data-dsh-aqua]::selection{background:rgba(110,155,232,0.35);}[data-dsh-aqua] [data-conversation-scroll]{text-shadow:0 0 1px rgba(0,0,0,0.4);}[data-dsh-aqua] body:not([data-ds-dark-theme]) [data-conversation-scroll]{text-shadow:0 0 1px rgba(255,255,255,0.55),0 1px 2px rgba(19,45,83,0.08);}[data-dsh-float] [role='dialog'] h2{font-family:'Space Grotesk Variable','Noto Serif SC','Songti SC','STSong','SimSun',serif;font-weight:600;letter-spacing:0.02em;}[data-dsh-float] [role='treeitem']{font-family:'Space Grotesk Variable','Noto Serif SC','Songti SC','STSong','SimSun',serif;font-weight:500;}[data-dsh-float] [data-phase='hero']{animation:dsh-aqua-hero-in 0.32s var(--ds-ease-in-out);}[data-dsh-float] [data-phase='active']{animation:dsh-aqua-active-in 0.3s var(--ds-ease-in-out);}[data-dsh-float] [data-testid^='view-']{animation:dsh-aqua-view-in 0.26s var(--ds-ease-in-out);}[data-dsh-float] [class*='userRow']{animation:dsh-aqua-rise 0.28s var(--ds-ease-in-out) both;}[data-dsh-float] [data-tool]{animation:dsh-aqua-rise 0.3s var(--ds-ease-in-out) both;}[data-dsh-float] [role='dialog']{animation:dsh-aqua-dialog-in 0.24s var(--ds-ease-in-out);}@keyframes dsh-aqua-hero-in{from{opacity:0;}}@keyframes dsh-aqua-active-in{from{opacity:0;}}@keyframes dsh-aqua-view-in{from{opacity:0;}}@keyframes dsh-aqua-rise{from{opacity:0;transform:translateY(6px);}}@keyframes dsh-aqua-dialog-in{from{opacity:0;transform:translateY(8px) scale(0.985);}}[data-dsh-compat] [role='menu'],[data-dsh-compat] [role='tooltip'],[data-dsh-compat] [class*='card'],[data-dsh-compat] [class*='bubble'],[data-dsh-compat] [class*='panel'],[data-dsh-compat] [class*='popover'],[data-dsh-compat] [class*='dropdown']{backdrop-filter:blur(12px);}@media (prefers-reduced-motion:reduce){[data-dsh-float] [data-phase='hero'],[data-dsh-float] [data-phase='active'],[data-dsh-float] [data-testid^='view-'],[data-dsh-float] [class*='userRow'],[data-dsh-float] [data-tool],[data-dsh-float] [role='dialog'],[data-dsh-aqua] [data-dsh-aqua-ambient],[data-dsh-aqua] [data-aqua-critter]{animation:none;}[data-dsh-aqua] [data-aqua-critter='bubble']{opacity:0;}}`;
  document.head.appendChild(tag);
}

// dshcss:D:\HuaweiMoveData\Users\DELL\Desktop\codex\Mineradio-DSH-Theme\src\client\fonts.module.css
if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("@deepseek-ai/dsh-client-ui-mineradio/src/client/fonts.module.css?v=8a003375") + "]") === null) {
  const tag = document.createElement("style");
  tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-mineradio";
  tag.dataset.pluginCss = "@deepseek-ai/dsh-client-ui-mineradio/src/client/fonts.module.css?v=8a003375";
